...
ssh $VPS "test -f $REMOTE_DIR/docker/.env || echo 'MYSQL_ROOT_PASSWORD=trading123
MYSQL_DATABASE=trading' > $REMOTE_DIR/docker/.env"
...
echo "View logs: ssh $VPS 'docker logs -f trading-surveillance-cron'"
